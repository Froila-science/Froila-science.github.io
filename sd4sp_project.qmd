...
::: {.column-screen-inset-shaded style="padding: 30px; margin-bottom: 40px; border-bottom: 1px solid #eee;"}
::: {layout="[70,30]" style="align-items: center;"}
...
![](sd4sp_logo_noback.png){height="90px"}
![](MSCA.png){height="90px"}
:::
