...
<div style="display: flex; flex-direction: column; align-items: center; gap: 15px; margin: 30px 0; background-color: #fcfcfc; padding: 20px; border-radius: 12px; border: 1px solid #eee;">
  ![**Animation:** Daily evolution and life cycle of the Stratospheric Polar Vortex from September to March.](polar_vortex_evolution.GIF){width="85%"}
...
<div style="display: flex; align-items: center; gap: 20px; background-color: #f8f9fa; padding: 20px; border-radius: 10px; border: 1px solid #dee2e6;">
  ...
  <div style="flex: 1;">
    ![**Figure 2:** Stratospheric-tropospheric coupling during SSWs.](downward_propagation.PNG){width="100%"}
  </div>
</div>

---

## Major Stratospheric Events Lists
