...
::: {style="text-align: center; margin: 30px 0; background-color: #fcfcfc; padding: 25px; border-radius: 12px; border: 1px solid #eee;"}
![](vortex.gif){width="85%"}
...
::: {.callout-note appearance="simple" icon=false style="background-color: #f8f9fa; border: 1px solid #dee2e6;"}
...
![Stratospheric-tropospheric coupling during SSWs.](downward_propagation.png){width="70%" .border .rounded}
:::
:::
