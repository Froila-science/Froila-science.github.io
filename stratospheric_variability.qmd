...
[← Back to Project Overview](sd4sp_project.html){style="text-decoration: none; color: #2c3e50;"}
...
## {{< bi arrow-down-circle >}} Downward Propagation
...
[A complete list of sudden stratospheric warmings can be found here](ssws.html){style="text-decoration: none; color: #2c3e50;"}<br>
...
[A complete list of strong polar vortex events can be found here](spvs.html){style="text-decoration: none; color: #2c3e50;"}<br>
[SSWs can be computed interactively with our tool](ssw_app.qmd){style="text-decoration: none; color: #2c3e50;"}
